...
import 'package:number_one_academy_v2/Presentation/Screens/Details/widgets/AppVideoPlayer.dart';
          ...
          child: Column(
            children: [
              ...
              BlocBuilder<CourseListBloc, CourseListState>(
                ...
                return AspectRatio(
                  aspectRatio: 16 / 9,
                  child: state.videoList.isNotEmpty
                      ? AppVideoPlayer(
                          key: ValueKey(state.chapterIndex),
                          currentVideo: state.videoList[state.chapterIndex!])
